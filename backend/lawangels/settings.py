...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'Law Angels <noreply@lawangelsuk.com>')

# Frontend URL for password reset links
FRONTEND_URL = os.getenv('FRONTEND_URL', 'https://lawangelsuk.com')

# Stripe Billing Configuration
STRIPE_SECRET_KEY = os.getenv('STRIPE_SECRET_KEY', '')
STRIPE_PUBLISHABLE_KEY = os.getenv('STRIPE_PUBLISHABLE_KEY', '')
STRIPE_WEBHOOK_SECRET = os.getenv('STRIPE_WEBHOOK_SECRET', '')
STRIPE_PRICE_ID = os.getenv('STRIPE_PRICE_ID', '')  # £750/year price ID from Stripe
