...
<path d="M117.689 9.78197C123.922 -3.15436 142.721 -1.96727 147.277 11.6503L179.432 107.764C179.899 109.159 180.556 110.483 181.384 111.698L238.462 195.447C246.549 207.313 236.121 223 222.05 220.137L122.736 199.927C121.294 199.634 119.819 199.541 118.352 199.65L17.2848 207.207C2.96532 208.277 -5.40624 191.403 4.10899 180.649L71.2679 104.745C72.2427 103.643 73.0608 102.412 73.6993 101.087L117.689 9.78197Z" fill="white" fill-opacity="0.66"/>
        ...
        <div className="md:hidden px-4 mt-20">
          <div className="bg-[#1A1D3E] rounded-2xl mt-8 p-5 shadow-md">
            ...
            <h2 className="text-xl font-semibold text-white font-crimson">How To Qualify as a solicitor via the SQE route</h2>
          </div>
          ...
          <div className="max-w-[720px] mx-auto mt-6 space-y-4">
            ...
            <div className="bg-white rounded-lg border border-gray-300">
              ...
              >
                <h4 className="font-semibold text-sm">Step 1: Meet the Eligibility Requirements</h4>
            ...
            <div className="bg-white rounded-lg border border-gray-300">
              <button
                ...
                className="w-full flex items-center justify-between text-left p-4"
              >
                <h4 className="font-semibold text-sm">Step 2: Pass SQE1 – Master Your Legal Knowledge</h4>
                <span className="text-lg font-bold text-gray-600 ml-2">
                  {openSteps.step2 ? '−' : '+'}
                </span>
              </button>
            ...
            <div className="bg-white rounded-lg border border-gray-300">
              <button
                ...
                className="w-full flex items-center justify-between text-left p-4"
              >
                <h4 className="font-semibold text-sm">Step 3: Complete Qualifying Work Experience (QWE)</h4>
                <span className="text-lg font-bold text-gray-600 ml-2">
                  {openSteps.step3 ? '−' : '+'}
                </span>
              </button>
            ...
            <div className="bg-white rounded-lg border border-gray-300">
              <button
                ...
                className="w-full flex items-center justify-between text-left p-4"
              >
                <h4 className="font-semibold text-sm">Step 4: Pass SQE2 - Showcase Your Practical Skills</h4>
                <span className="text-lg font-bold text-gray-600 ml-2">
                  {openSteps.step4 ? '−' : '+'}
                </span>
              </button>
            ...
            <div className="bg-white rounded-lg border border-gray-300">
              <button
                ...
                className="w-full flex items-center justify-between text-left p-4"
              >
                <h4 className="font-semibold text-sm">Step 5: Pass the Character and Suitability Check</h4>
                <span className="text-lg font-bold text-gray-600 ml-2">
                  {openSteps.step5 ? '−' : '+'}
                </span>
              </button>
