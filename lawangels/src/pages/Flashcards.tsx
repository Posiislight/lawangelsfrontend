...
import { BookOpen, Menu, X, Bell, Home, BarChart3, HelpCircle, Book, Video, Grid, Brain, FileText, Bot, Lightbulb, Clock, ArrowRight, ChevronRight, Zap, Award, RotateCw } from 'lucide-react'
        ...
        <nav className="flex-1 p-4 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Link to="/flashcards" className="block">
              <NavItem icon={<Grid className="w-5 h-5" />} label="Flashcard" active={true} open={sidebarOpen} />
            </Link>
