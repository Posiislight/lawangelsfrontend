        ...
        <div className='hidden md:block'>
          ...
          <div className='flex max-w-[1200px] mx-auto mt-10 mb-20 items-start gap-8'>
            <div className='w-9/12'>
              ...
              <div className='mb-8 bg-white rounded-lg border border-gray-300'>
                ...
                {openSections.realistic && (
                  <div className='p-4 pt-0'>
                    <p className='text-base text-gray-700 mt-4'>
                      Our SQE1 multiple-choice questions and full-length mocks mimic the real exam, helping you master time management. Join for unlimited mocks to boost confidence and pass rates.
                    </p>
                  </div>
                )}
              </div>
            ...
            <aside className='w-3/12 bg-white rounded-2xl border border-[#0089FF] shadow-lg p-6 flex flex-col'>
              ...
              <div className='text-sm text-gray-700 mb-5'>Subscribe for Mock MCQs and Exam tips.</div>
        ...
        <div className='md:hidden px-4 mt-20'>
          ...
          <div className='max-w-[720px] mx-auto mt-6 space-y-4'>
            <div className='mb-4 bg-white rounded-lg border border-gray-300'>
              ...
              >
                <div className='flex items-center justify-between'>
                  <h4 className='font-semibold text-sm'>Tailored Study Plans</h4>
            ...
            <div className='mb-4 bg-white rounded-lg border border-gray-300'>
              ...
              >
                <div className='flex items-center justify-between'>
                  <h4 className='font-semibold text-sm'>Realistic Mock Exams</h4>
                  <span className='text-lg font-bold text-gray-600'>
                    {openSections.realistic ? '−' : '+'}
                  </span>
                </div>
            ...
            <div className='mb-4 bg-white rounded-lg border border-gray-300'>
              ...
              >
                <div className='flex items-center justify-between'>
                  <h4 className='font-semibold text-sm'>Expert Resources</h4>
                  <span className='text-lg font-bold text-gray-600'>
                    {openSections.expert ? '−' : '+'}
                  </span>
                </div>
            ...
            <div className='mb-4 bg-white rounded-lg border border-gray-300'>
              ...
              >
                <div className='flex items-center justify-between'>
                  <h4 className='font-semibold text-sm'>Affordable Prep & Funding</h4>
                  <span className='text-lg font-bold text-gray-600'>
                    {openSections.affordable ? '−' : '+'}
                  </span>
                </div>
          ...
          <aside className='w-full bg-white rounded-2xl border border-[#0089FF] shadow-lg p-4 mt-6 mb-4'>
            <p className='text-sm text-gray-700'>Subscribe for Mock MCQs and Exam tips.</p>
