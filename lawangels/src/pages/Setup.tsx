...
import { Target, RefreshCw, BookOpen, Plus, Eye, EyeOff } from 'lucide-react'
...
export default function Setup() {
  ...
  const handleNext = () => {
    if (step === 1 && fullName && email && password) {
      setStep(2)
    } else if (step === 2 && studyGoal && studyTime && selectedAvatar) {
      setStep(3)
    } else if (step === 3 && billingAddress && city && postcode && paymentMethod && country) {
      navigate('/dashboard')
    }
  }
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex justify-center gap-4 mb-8">
          <button className={`px-6 py-2 rounded-lg font-medium transition ${
            step === 1 ? 'bg-white border border-[#E2E8F0]' : 'text-[#617289]'
          }`}>
            Sign Up
          </button>
          <button className="px-6 py-2 text-[#617289] font-medium">Log In</button>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 border border-[#E2E8F0] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0089FF] focus:border-transparent"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3 border border-[#E2E8F0] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0089FF] focus:border-transparent"
                />
                <button
                  type="button"
        ...
        {/* Step 2: Personalize Your Learning */}
        {step === 2 && (
            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-3">
                {[
                  ...
                  <button
                    key={option.value}
                    onClick={() => setStudyTime(option.value as StudyTime)}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-[#E2E8F0] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0089FF] focus:border-transparent"
                />
              </div>
              <div>
