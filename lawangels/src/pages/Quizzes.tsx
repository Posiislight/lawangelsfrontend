...
import { BookOpen, Menu, X, Bell, Home, BarChart3, HelpCircle, Book, Video, Grid, Brain, FileText, Bot, Lightbulb, Clock, ArrowRight, ChevronRight, CheckCircle, TrendingUp } from 'lucide-react'
        ...
        <nav className="flex-1 p-4 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Link to="/quizzes" className="block">
              <NavItem icon={<Brain className="w-5 h-5" />} label="Quizzes" active={true} open={sidebarOpen} />
            </Link>
