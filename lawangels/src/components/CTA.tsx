        ...
        <div className="relative w-full font-worksans">
            ...
            <div className="relative h-screen overflow-hidden">
                ...
                <div className="relative z-10 max-w-6xl mx-auto px-4 h-full flex flex-col justify-center">
                    ...
                    {/* CTA Button */}
                    <Link to="/register" className="inline-block mt-8 px-8 py-3 bg-orange-500 text-white font-semibold rounded-lg transition-all duration-300 hover:bg-orange-600 hover:shadow-lg hover:scale-105">
                        Start Your Journey
                    </Link>
                </div>
            </div>
