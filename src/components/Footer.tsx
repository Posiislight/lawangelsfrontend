...
export default function Footer() {
  return (
    ...
    <footer className="hidden md:block text-white font-worksans">
    ...
    {/* Mobile styling */}
    <footer className="block md:hidden text-white font-worksans">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          <h2 className="text-2xl font-semibold text-[#2B3443]">
            Ready to Start Your <br /> Legal Career?
          </h2>
          <p className="mt-3 text-sm text-[#035C83]">
            Don’t leave your success to chance. Get structured guidance,
            comprehensive resources, and the confidence to ace your SQE exams
            on your first try.
          </p>
          <button className="bg-[#0089FF] text-white px-6 py-2.5 rounded-full mt-5 font-semibold hover:scale-105 duration-300">
            Start your Journey
          </button>
        </div>
      </div>
      ...
      {/* Footer content */}
      <div className="-mt-4 bg-[#0b0b0b] rounded-t-3xl px-6 py-10 relative z-20">
        {/* Logo + Brand */}
        <div className="flex flex-col items-center text-center mb-8">
          <div className="w-24 h-24 mb-3">
            <img src={logo} alt="Law Angels logo" className="w-full h-full object-contain" />
          </div>
          <h3 className="text-2xl font-bold text-[#2B9BD1]">Law Angels</h3>
          <p className="mt-2 text-sm text-gray-400">
            Pathways, resources, and expert guidance for your SQE journey.
          </p>
        </div>

        {/* Footer Links - collapsed for mobile */}
        <div className="space-y-6 text-center">
          <div>
            <h4 className="text-[#81D6FB] font-semibold mb-2">Quick Links</h4>
            <ul className="text-sm text-gray-300 space-y-2">
              <li>Path to Qualification</li>
              <li>Prep Tools</li>
              <li>About Us</li>
              <li>Get in Touch</li>
            </ul>
          ...
          {/* Social icons */}
          <div>
            <h4 className="text-[#81D6FB] font-semibold mb-2">Stay Connected</h4>
        ...
        {/* Bottom text */}
        <div className="mt-8 border-t border-gray-700 pt-6 text-center space-y-3 text-xs text-gray-400">
          <p>Terms &amp; condition &nbsp; | &nbsp; Privacy &nbsp; | &nbsp; Cookies</p>
          <p>© 2025 Law Angels. All rights reserved.</p>
        </div>
      </div>
    </footer>
    </>
